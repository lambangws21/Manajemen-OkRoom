...
export default function App() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-sky-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-6">
