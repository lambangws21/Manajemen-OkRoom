...
export default function Button({ 
  ...
  const baseClasses = 'font-semibold text-white transition-colors focus:outline-none focus:ring-1 focus:ring-offset-1 flex items-center justify-center rounded-lg';
